...
export default function Task7Form() {
  ...
  return (
    <>
      <Title />
      <h2>Система предлагает вектор булевой функции, пользователь вводит её КНФ</h2>
      <CustomButton onClick={handleGenerate}>Начать</CustomButton>
      {vector && (
        <>
          <h2 className="!pt-50">Введите КНФ по вектору:</h2>
          <pre>{vector}</pre>
          <ul>
...
function Title() {
  return (
    <HintedTitle title="Задание 7">
      <p>
        <b>Конъюнктивной нормальной формой</b> (КНФ) называется конъюнкция элементарных дизъюнкций.
      </p>
      <p>
        <i>Элементарной дизъюнкцией</i> называется выражение, представляющее собой дизъюнкцию переменных и/или их отрицаний.
      </p>
    </HintedTitle>
  )
}
